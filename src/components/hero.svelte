<template>
	<div class="py-40">
		...
		<div class="flex justify-center">
			<button
				class="flex gap-3 items-center bg-green-400 hover:bg-green-500 text-white py-4 px-12 rounded-full font-roboto font-medium text-lg transition-all"
				><svg
